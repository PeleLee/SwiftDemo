...
class ContentVC1: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        case .OpaqueTypes:
            opaqueTypes()
        case .AutomaticReferenceCounting:
    ...
    private func languageReference() {
        var note = ""
        ...
        let notes = [myLB,
                     ...
                     "内容整理在 Swift.xmind中",
                     separatorStr1 + myLB,
                     "代码在 LanguageReference.playground 中",
                     separatorStr1 + myLB,
        ]
    ...
    private func advancedOperators() {
        var note = ""
        let myLB = myLineBreak()
        let notes = [myLB,
                     statementStr1,
                     ...
                     "内容整理在 Swift.xmind中",
                     separatorStr1 + myLB,
                     "代码在 AdvancedOperators.playground 中",
                     separatorStr1 + myLB,
        ]
    ...
    private func accessControl() {
        ...
        let notes = [myLB,
                     ...
                     "内容整理在 Swift.xmind中",
                     separatorStr1 + myLB,
                     "代码在 AccessControl.playground 中",
                     separatorStr1 + myLB,
        ]
    ...
    private func automaticReferenceCounting() {
        var note = ""
        let myLB = myLineBreak()
        let notes = [myLB,
                     statementStr1,
                     ...
                     "内容整理在 Swift.xmind中",
                     separatorStr1 + myLB,
                     "代码在 AutomaticReferenceCounting.playground 中",
                     separatorStr1 + myLB,
        ]
